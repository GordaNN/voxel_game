                    ...
                    for (int j = 0; j < CHUNK_OCTREE_SIZE; ++j)
                    {
                        for (int k = 0; k < CHUNK_OCTREE_SIZE; ++k)
                        {
                            const vec3f_t voxel_position = vec3f_create(
                                    CORE_VOXEL_MIN_SCALE *
                                        (i - CHUNK_OCTREE_HALF_SIZE) + CORE_VOXEL_HALF_MIN_SCALE,
                                    CORE_VOXEL_MIN_SCALE *
                                        (j - CHUNK_OCTREE_HALF_SIZE) + CORE_VOXEL_HALF_MIN_SCALE,
                                    CORE_VOXEL_MIN_SCALE * 
                                        (k - CHUNK_OCTREE_HALF_SIZE) + CORE_VOXEL_HALF_MIN_SCALE);
